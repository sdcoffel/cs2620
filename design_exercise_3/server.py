...
if __name__ == "__main__":
    ...
    for port, server_id in zip(ports, server_ids):
        ...
        # Register the new server in ZooKeeper
        register_new_server(server_id, server_address)

        # Notify existing servers about this new server
    ...
    try:
        while True:
            ...
            if command == "add":
                # Gather details for the new server
                ...
                # Register in ZooKeeper and notify all other servers
                ...
                # Keep track of dynamically added servers
