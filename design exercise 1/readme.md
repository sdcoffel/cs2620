...
When the user on the client GUI requests to see more pending messages, they are sent in batches of 10. This was a design choice as this seemed like a reasonable number of pending messages to show at one time.
