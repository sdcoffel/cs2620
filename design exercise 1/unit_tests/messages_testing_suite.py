...
class TestMessageManager(unittest.TestCase):
    ...
    @patch(
        "builtins.open",
        mock_open(
            read_data="uuid1,2020-01-01 12:00,alice,bob,Hello!\n"
    ...
    def test_random_message_operations(self):
        ...
        mock_data = "".join(
            f"{msg['uuid']},{msg['datetime']},{msg['sender']},{msg['receiver']},{msg['content']}\n"
    ...
    def test_store_pending_message(self):
        ...
        message = create_message(
            sender, receiver, content, self.pending_messages
